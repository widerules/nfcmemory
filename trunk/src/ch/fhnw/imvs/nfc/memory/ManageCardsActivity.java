    ...
    extends Activity
{
    ...
    protected void onResume()
    {
        ...
        try
        {
            ...
            cardCounter.setText(cards.size()
                + getString(R.string.number_of_cards));
        }
    ...
    public void onBackPressed()
    {
        ...
        else
        {
            ...
            final CharSequence[] possibilities =
                getResources().getStringArray(
                    R.array.impossible_number_of_cards_dialog);

            new AlertDialog.Builder(this)
                .setItems(possibilities, new OnClickListener()
                {
                    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        case R.id.delete_memorized_cards:
            new AlertDialog.Builder(this)
                .setTitle(R.string.request_delete_all_cards)
    ...
    public boolean onContextItemSelected(MenuItem item)
    {
        ...
        case R.id.delete_card:
            new AlertDialog.Builder(this)
                .setTitle(R.string.request_delete_card)
                .setIcon(android.R.drawable.ic_dialog_alert)
                .setPositiveButton(android.R.string.ok,
                    new DialogInterface.OnClickListener()
                    {
    ...
    public void onNewIntent(Intent intent)
    {
        ...
        if (item != null && item != "00")
        {
            ...
            {
                statusBar.setText(String.format(getString(R.string.tag_added),
                    item));
    ...
    private void saveCards()
    {
        JSONSharedPreferences.saveJSONArray(this,
            SharedPreferencesKeys.PREF_NAME, SharedPreferencesKeys.CARDS_KEY,
            new JSONArray(cards));
    }
